...
public final class CoarseLists {
   ...
   * accesses.
   *
   * TODO Implement the add, remove, and contains methods below to support correct, concurrent
  ...
  public static final class CoarseList extends ListSet {
    /*
     * TODO Declare a lock for this class to be used in implementing the concurrent add, remove, and
     * contains methods below.
     */
     ...
     * concurrent accesses. You may refer to SyncList.java for help understanding the list
     * management logic, and for guidance in understanding where to place lock-based
     * synchronization.
     */
    public static final class RWCoarseList extends ListSet {
      /*
       * TODO Declare a read-write lock for this class to be used in implementing the concurrent
